...
counter = 18
log = [average_before for _ in range(200)]
...
while True:
    ...
    if counter == 18:  # interval = 18s
        ...
        printstring("Current", 20, 30, 2, False, False, WHITE)
        printstring(f"{temp:.3f} [C]", 20, 55, 3, False, False, WHITE)
        printstring("Average", 20, 85, 2, False, False, WHITE)
        printstring(f"{average:.3f} [C]", 20, 110, 3, False, False, accent)
